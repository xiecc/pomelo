...
=======
	this.loadConfig('servers', Application.get('dirname') + '/config/servers.json');
	this.loadConfig('master', Application.get('dirname') + '/config/master.json');
	this.loadConfig('logger', Application.get('dirname') + '/config/log4js.json');
>>>>>>> 49de30601d5fc44779cd61cd8fb544ecefe7b6dc
	this.processArgs();
};
...
<<<<<<< HEAD
	...
	this.load(pomelo.logger);
=======
		Application.load(pomelo.master);
	} else {
		Application.load(pomelo.proxy, Application.get('proxyConfig'));
		Application.load(pomelo.remote, Application.get('remoteConfig'));
		Application.load(pomelo.handler);
		if(Application.isFrontend()) {
			Application.load(pomelo.connection);
		}
		Application.load(pomelo.server);
	}
	Application.load(pomelo.monitor);
	Application.load(pomelo.logger);
>>>>>>> 49de30601d5fc44779cd61cd8fb544ecefe7b6dc
};
 ...
 * @api public
 */
app.getServerById = function(serverId) {
 ...
 * @api public
 */
app.getServersByType = function(serverType) {
