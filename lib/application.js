...
Application.processArgs = function(){
	...
	this.set('serverType', args.serverType || 'master');
	this.set('serverId', args.serverId || this.master.id);
	if(args.serverType !== 'master') {
	      this.set('server', Application.findServer(args.serverType, args.serverId));
	}
