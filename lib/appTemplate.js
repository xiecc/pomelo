...
exports.init = function () {
    ...
    var debug = hm['--debug'] === undefined ? 'false' : hm['--debug'];
    var debugPorts = hm['--debugPorts'] === undefined ? 'false' : hm['--debugPorts'];
    var gc = hm['--gc'] === undefined ? 'false' : hm['--gc'];
    var prof = hm['--prof'] === undefined ? 'false' : hm['--prof'];
    var trace = hm['--trace'] === undefined ? 'false' : hm['--trace'];
    ...
    app.set('debug', debug);
    app.set('debugPorts', debugPorts);
    app.set('gc', gc);
    app.set('prof', prof);
    app.set('trace', trace);
    console.error('application inited: %j', app.serverId);
    return app;
};
