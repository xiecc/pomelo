 ...
 */
module.exports.createServer = function(app, opts) {
...
var Server = function (app, opts) {
  ...
  this.flushInterval = opts.flushInterval || 200;  //client message flush interval. default 100ms
...
pro.afterStart = function() {
  ...
  if(this.app.isFrontendServer()) {
    startWebsocket(this.server.wsPort, this);
  }
};
...
/**
 * Start to listen the websocket port
 *
