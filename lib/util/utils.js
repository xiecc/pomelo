 ...
 */
utils.removeElement = function (obj, arr) {
    if (!obj || !arr) {
        return null;
    }
    var pos = -1;
...
/**
* pomelo list format output
*/

utils.pomelo_list_format_output = function(msg){
    ...
    for(var key in msg){
        ...
        console.log(result);
        //console.log(msg[key]['serverId'] + '             ' + msg[key]['serverType'] + '         ' + msg[key]['pid'] + '            ' + msg[key]['cpuAvg'] + '        ' + msg[key]['memAvg'] + '       ' + msg[key]['time']);
    }
}