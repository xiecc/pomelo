...
/**
 * Component provides low level network and protocol details implementation between server and clients.
 * Developer can provide their own connector and adapt pomelo to different client protocol, such as tcp or probuf and etc.
 */
...
Component.prototype.afterStart = function(cb) {
	...
	this.connector = this.app.get('connector') || getDefaultConnector(this.app);
