...
Pomelo.utils = require('./util/utils');
Pomelo.handlerManager = require('./handlerManager');
Pomelo.filterManager = require('./filterManager');
Pomelo.channelService = require('./common/service/channelService');
Pomelo.taskManager = require('./common/service/taskManager');
Pomelo.log = require('./util/log/log');
Pomelo.statusService = require('./common/service/statusService');
