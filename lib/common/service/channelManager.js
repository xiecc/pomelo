...
var sendMessageByGroup = function(msg, groups, cb) {
	...
	for(var key in groups) {
		...
		(function() {
			...
			rpcClient.rpcInvoke(serverId, {namespace: namespace, service: service, method: method, args: [msg, uids]}, function(err) {
				if(!!err) {
