...
/**
 * User logined callback.
 * This method would bind the uid with the session.
 */
...
/**
 * Response method for the session that should be defined outside.
 */
...
/**
 * Kick the session offline.
 * This would be invoked when the session has kicked and do some clean jobs.
 */
...
/**
 * Util function that unset value for session.
 */
