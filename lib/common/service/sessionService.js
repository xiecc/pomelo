...
/**
 * Session service manages the sessions for each client connection. Session service 
 * is created by session component and is only available in frontend servers. There 
 * is another LocalSessionService provides session service for backend servers. You 
 * can access the service by app.get('sessionService') in frontend servers.
 *
 * @param {Object} opts constructor parameters
 *                      opts.sendDirectly - whether send the request to the client 
 *                      	directly or cache them until next flush.
 * @class
 * @constructor
 */
 ...
 *
 * Session is generated in frontend server.
 *
 * @class
 * @constructor
 */
